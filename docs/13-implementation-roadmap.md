...
- Admin user CRUD; self-profile; bootstrap admin seed.
- **Demo:** log in as admin, create a user, reset password via emailed OTP. *(Authorization matrix tests start here.)*
