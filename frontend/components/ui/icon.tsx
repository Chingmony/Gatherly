...
/** lucide-style stroke icon set ported from the design prototype. */
const ICONS: Record<string, ReactNode> = {
  ...
  chv: <polyline points="6 9 12 15 18 9" />,
  pin: (
    <>
...
export function Ic({ n, sz = 18, c = 'currentColor', sw = 1.75 }: IconProps) {
  return (
    <svg
      width={sz}
      height={sz}
