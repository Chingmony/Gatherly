...
const EVENT_CATEGORIES = ["Conference", "Workshop", "Webinar", "Networking", "Festival", "Gala", "Hackathon", "Other"];
...
export default function EditEventPage() {
  ...
  const [form, setForm] = useState({
    ...
    category: "Conference" as string, hasCapacity: false, capacity: "",
  });
  ...
  useEffect(() => {
    ...
    getEvent(id)
      .then((ev) => {
        ...
        setCurrentCover(ev.coverImageUrl);
      })
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      const coverImageUrl = coverFile ? await uploadEventCover(coverFile) : undefined;
